...
public class AddBuah extends javax.swing.JFrame {
   ...
   if(this.FRAK.getText().isEmpty() ){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBuah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
