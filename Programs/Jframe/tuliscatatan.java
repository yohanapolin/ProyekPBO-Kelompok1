 ...
 * @author ITD
 */
public class tuliscatatan extends javax.swing.JFrame {
    ...
    private void addbbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbbActionPerformed
        ...
        if(!"Required!".equals(this.req.getText())&& !"Required!".equals(this.req1.getText())&& !"Required !".equals(this.req2.getText()) && !"Required !".equals(this.req3.getText())&& !"Required !".equals(this.req4.getText())&& !"Required !".equals(this.req5.getText())){
           a.Catatan_restock(this.f11.getText(), this.f22.getText(), this.f33.getText(), this.f44.getText(), this.f55.getText(), this.f66.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tuliscatatan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tuliscatatan().setVisible(true);
            }
        });
    }
