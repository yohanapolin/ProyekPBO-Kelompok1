...
public class Catatanlihat extends javax.swing.JFrame {
    ...
    public void reset(){
        if(this.maxi > 0) {
            ...
            this.id.setText ("ID.Restock : " );
            this.tanggal.setText ("Tanggal Restock : " );
            this.jenis.setText ("Jenis Buah : " );
            this.jumlah.setText ("Jumlah (Kg) : ");
            this.harga.setText ("Harga (Rp) : " );
            this.sup.setText ("Supplier : " );
        }
