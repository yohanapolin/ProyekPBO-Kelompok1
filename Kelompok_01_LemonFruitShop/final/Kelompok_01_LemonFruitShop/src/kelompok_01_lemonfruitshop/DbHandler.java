...
public class DbHandler {
   ...
   public List<Buah> getallbuah(){
    ...
    public List<Laporan> getalllaporan(){
       this.counter = 0;
		List<Laporan> buff = new ArrayList<Laporan>();
                Laporan buf2 = null;
                if (this.connected) {
			String query = "SELECT No_Laporan, JenisLaporan, Tanggal_Laporan FROM db_lemonshop.laporan";
			try {
    ...
    public void addLaporan(String No_Laporan, String JenisLaporan, String Tanggal_Laporan) {
		...
		if (this.connected) {
			String query = "INSERT INTO `db_lemonshop`.`laporan` (`No_Laporan`, `JenisLaporan`, `Tanggal_Laporan`) VALUES ('" + No_Laporan +"','" + JenisLaporan +"','"+ Tanggal_Laporan +"');";
			try {
                            Statement stmt = this.connection.createStatement();
                            ResultSet resultSet = stmt.executeQuery(query);
     ...
     public void addCatatan_restock(String ID_Transaksi, String Tanggal, String nama_buah, String Jumlah, String Supplier, String Harga_beli) {
		
		if (this.connected) {
			String query ="INSERT INTO `db_lemonshop`.`transaksi_restok` (`ID_Transaksi`, `Tanggal`, `nama_buah`, `Jumlah`, `Supplier`, `Harga_beli`) VALUES ('" + ID_Transaksi + "'," + "'" + Tanggal + "'" 
 ...
 public RakBuah Add (String rak_id,String Kapasitas){
             RakBuah rak = null;
               if (this.connected) {
			String query = "INSERT INTO `db_lemonshop`.`rakbuah` (`ID_Rak`, `Kapasitas`) VALUES ("+"'" + rak_id + "',"  + Kapasitas +");";
  ...
  public void addTransaksi(int pembayaran,int harga , int jumlahbuah , int kembalian, int total) {
