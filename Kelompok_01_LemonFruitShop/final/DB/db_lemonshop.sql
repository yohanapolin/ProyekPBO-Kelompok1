...
INSERT INTO `buah` (`Id_buah`, `nama_buah`, `Stok`, `Harga`, `Tanggal_Kadaluarsa`, `ID_Rak`) VALUES
	...
	('120040', 'semangka', 10, 20000, '2020-12-12', '140010');
...
-- Dumping data for table db_lemonshop.laporan: ~5 rows (approximately)
...
INSERT INTO `laporan` (`No_Laporan`, `JenisLaporan`, `Tanggal_Laporan`, `Kasir`, `Pengawai`) VALUES
	...
	('130006', 'Pejualan', '2020-06-14', '12001', NULL);
...
-- Dumping data for table db_lemonshop.rakbuah: ~12 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `transaksi` (
  `pembayaran` int(11) unsigned NOT NULL,
  `harga` int(11) DEFAULT NULL,
...
-- Dumping data for table db_lemonshop.transaksi: ~0 rows (approximately)
...
-- Dumping data for table db_lemonshop.transaksi_restok: ~5 rows (approximately)
/*!40000 ALTER TABLE `transaksi_restok` DISABLE KEYS */;
INSERT INTO `transaksi_restok` (`ID_Transaksi`, `Tanggal`, `nama_buah`, `Jumlah`, `Supplier`, `Harga_beli`) VALUES
	('2100001', '2020-06-13', 'Apel', 20, 'Masayu ', 20000),
	('2100001', '2020-06-13', 'Jeruk', 30, 'Masayu', 15000),
	('2100001', '2020-06-13', 'mangga', 20, 'Masayu', 20000),
	('2100002', '2020-06-14', 'mangga', 30, 'Dimas', 20000),
	('210003', '2020-12-12', 'Apel', 20, 'Dimas', 20000);
