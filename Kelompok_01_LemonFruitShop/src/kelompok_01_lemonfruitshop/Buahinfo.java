 ...
 * @author kylex
 */
public class Buahinfo extends javax.swing.JFrame {
  ...
  addbuah.setVisible(true);    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buahinfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
