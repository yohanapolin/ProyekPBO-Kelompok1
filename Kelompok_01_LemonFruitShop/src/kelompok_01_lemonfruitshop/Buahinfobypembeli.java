 ...
 * @author kylex
 */
public class Buahinfobypembeli extends javax.swing.JFrame {

    DbHandler a = new DbHandler();

    public Buahinfobypembeli() {
        initComponents();
        label_found.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buahinfobypembeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Buahinfobypembeli().setVisible(true);
            }
        });
    }
